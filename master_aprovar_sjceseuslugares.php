...
<!-- tres banners
 <div class="col-md-9">
    <h2 class="blue">
        <div title="Assuntos" class="the-icons span3">São José e Seus Lugares <i class="icon-angle-double-right"></i></div>
    </h2>
...
<div class="col-md-12">
    <h2 class="red">
        <div title="Code: 0xe807" class="the-icons span3">TV Câmara<i class="icon-angle-double-right"></i>
            ...
            <a href="http://www.camarasjc.sp.gov.br/assista.php">
        ...
        <div class="row">
            ...
            <div class="col-md-6 right-content">
                <div id="feed-texto">
                    ...
                    <p id="desc-playlist">Criada em 2013, a emissora legislativa de São José dos Campos pode ser
                        sintonizada pelos canais 7 e 29 da operadora NET, além do próprio site da Câmara. Informação e
                        prestação de serviço para a população, com os temas que realmente são importantes você encontra
                        aqui.</p>
                </div>
                ...
                <div class="row ">
                    <div class="video col-md-4 col-xs-4 loader-gif">
                        <a href="javascript:void(0);"><img
                                src="http://camarasjc2.hospedagemdesites.ws/2015/imgs/home/reportagens.jpg"
                                class="img-responsive" id="reportagens-btn"></a>
                    </div>

                    <div class="video col-md-4 col-xs-4 loader-gif">
                        <a href="javascript:void(0);"><img
                                src="http://camarasjc2.hospedagemdesites.ws/2015/imgs/home/com-a-palavra.jpg"
                                class="img-responsive" id="com-a-palavra-btn"></a>
                    </div>

                    <div class="video col-md-4 col-xs-4 loader-gif">
                        <a href="javascript:void(0);"><img
                                src="http://camarasjc2.hospedagemdesites.ws/2015/imgs/home/sessoes.jpg"
                                class="img-responsive" id="sessao-btn"></a>
                    </div>
                </div>
