...
class Twitter {
  ...
  public function ListTweets($consumer_key, $consumer_secret, $user_token, $user_secret, $screen_name, $count){
    
    $connection = new Twitter(array(
    'consumer_key' => $consumer_key,
    'consumer_secret' => $consumer_secret,
    'user_token' => $user_token, //access token
    'user_secret' => $user_secret //access token secret
    ));
    ...
    if ($screen_name) {
    $parameters['screen_name'] = strip_tags($screen_name);
    }
  ...
  /**
	...
	public static function TimeAgo($time)
	{
		...
		{
			return "há " . floor($delta / 60) . " minutos";
		}
