...
class FusionCharts{
	...
	var $SWFScript;                 # relative path of FusionCharts SWF files
...
##------------ PUBLIC FUNCTIONS ----------------------------------------------------------------
	 ...
	 function setSWFPath($SWFPath){
	 	$this->SWFScript=$SWFPath;
	   $this->SWFPath=$SWFPath . "charts/";
	   $this->SWFFile=$this->SWFPath . "FCF_" . $this->chartSWF[$this->chartType][0]  . ".swf";
	 }
	...
	# setTLine create TrendLine parameter 
	 ...
	 function renderChart(){
		...
		$this->SWFFile=$this->SWFPath . "FCF_" . $this->chartSWF[$this->chartType][0]  . ".swf";
	    # print the charts
		echo '<script type="text/javascript" src="' . $this->SWFScript . 'fusioncharts.js"></script>';
