 ...
 */
  ...
  * @access public
  */
  function SetLanguage($langcode = 'pt-br', $lang_path = 'lang/') {
    ...
    if ($langcode != 'en') { //There is no English translation file
      $l = @include $lang_path.$langcode.'.php';
    }
