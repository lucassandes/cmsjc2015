...
$oCategoriaLink->SQLWhere = " 1 = 1 ";

$palavra = $_GET["palavra"];
if($palavra)
{
	$oCategoriaLink->SQLWhere .= " AND Titulo LIKE '%" . $palavra . "%' ";
}

$oPaginator = new Paginator($oCategoriaLink->GetCount());
$oCategoriaLink->SQLOrder = "Ordem DESC";
$oCategoriaLink->LoadByPaginator($oPaginator->Limit, $oPaginator->Total);
...
if($oPaginator->TotalRecords > 0)
{
	...
	<table class="lista">
		...
		<tbody>
			...
			{
				$Param = "?" . $oPaginator->ParameterWithPage . "&id=" . $oCategoriaLink->ID;
				?>
				<tr>
					<td><?=$oCategoriaLink->Titulo;?></td>
					<td align="center">
