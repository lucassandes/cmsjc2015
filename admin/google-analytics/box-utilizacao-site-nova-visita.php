...
if($reportGrafico)
{
	...
	{
		array_push($data, $oGoogleAnalytics->Calculate($v["ga:newVisits"], $v["ga:visits"], true, false));
...
$g = new graph();
$g->title("% Novas visitas", "{padding-bottom:5px; font-size:18px}");
$g->bg_colour = "#FFFFFF";
$g->set_data($data);
$g->area_hollow(2, 5, 25, "#0e68be");
$g->set_tool_tip("% Novas visitas: #val#%<br>Data: #x_label#");
