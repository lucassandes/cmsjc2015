...
if($reportGrafico)
{
	...
	{
		array_push($data, $oGoogleAnalytics->Calculate($v["ga:pageviews"], $v["ga:visits"], false, false));
...
$g = new graph();
$g->title("Visualizações/Visitas", "{padding-bottom:5px; font-size:18px}");
$g->bg_colour = "#FFFFFF";
$g->set_data($data);
$g->area_hollow(2, 5, 25, "#0e68be");
$g->set_tool_tip("Visualizações/Visitas: #val#<br>Data: #x_label#");
