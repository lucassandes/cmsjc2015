...
if($_POST)
{
	...
	$oValidator->Add("Titulo", $oFiltro->Titulo, true, null, "Digite o título.");
...
<form action="" method="post" class="formMensagem">
	<ul>
    	<li>
			<label>
				Título*:
				<input size="60" maxlength="150" type="text" id="txtTitulo" name="txtTitulo" value="<?=$oFiltro->Titulo;?>" class="{required:true, focus:true}" title="Digite o título." />
			</label>
		</li>
	</ul>
