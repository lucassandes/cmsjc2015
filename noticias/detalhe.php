...
$oMasterPage->Init("../master.php", utf8_encode($oNoticia->Titulo));
...
?>
    ...
    if (!$oNoticia->IsClear($oNoticia->Descricao)) {
        ...
        <div class="fckEditor">
            ...
            $string = $oNoticia->HTMLDecode($oNoticia->Descricao);
                    ...
                    <li>
                        <a href="<?= $oNoticiaArquivo->DownloadURL($oNoticiaArquivo->Arquivo); ?>">
                            <span class="glyphicon glyphicon-download-alt"
                                  aria-hidden="true"></span> <?= utf8_encode($oNoticiaArquivo->Titulo); ?> <span
                                class="download-arquivo hidden-xs hidden-sm">Download do Arquivo</span>
                        </a>
                    </li>
                    <?php
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="popRSS">
                        ...
                        <p><strong>O QUE É RSS?</strong><br/>
                            O RSS (Really Simple Syndication) é uma forma prática de receber todas as notícias do
                            Reseller Web no mesmo momento em que elas são publicadas. Através de softwares que utilizam
                            protocolo XML chamados RSS feeders, ou Agregadores RSS, você pode adicionar as páginas do
                            Reseller Web e de seus sites preferidos em uma única tela e a cada notícia publicada, você
                            recebe um aviso sem que você precise navegar até o site onde a notícia foi gerada.</p>
                        ...
                        <p>
                            ...
                            fontes de notícia que são incorporadas automaticamente.<br/>
                            e-FastNews 1.2 (Freeware): Leitor RSS em português.<br/>
                            Active Web Reader 2.42 (Freeware): Simples de usar, mas é em inglês.<br/>
                            Pluck 2.0 Beta 1 (Freeware): Leitor de RSS gratuito que roda no Internet Explorer 6.0 ou
                            mais recente.<br/>
                            RSSOwl (Freeware): Leitor de notícias RSS e RDF escrito em Java.<br/>
                            FeedReader 2.9 (opensource): Popular programa XML<br/>
                        </p>
                        ...
                        <p>
                            ...
                            disponíveis em RSS, bastando que você clique
                        </p>
                    </div>
                </div>
                <div class="modal-footer">
